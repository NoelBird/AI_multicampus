...
comVisionMenu4.add_command(label="블러링", command=embossImage)
comVisionMenu4.add_command(label="샤프닝", command=sharpImage)
# comVisionMenu4.add_command(label="경계선 검출", command=detectLineImage)
comVisionMenu4.add_command(label="가우시안 필터링", command=gaussianImage)
comVisionMenu4.add_command(label="고주파", command=hiFreqImage)
comVisionMenu4.add_command(label="저주파", command=lowFreqImage)
# comVisionMenu4.add_command(label="에지 검출", command=detectEdgeImage)
